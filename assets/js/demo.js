...
//       var chatArea = $(this).closest(".chat-area"); // Parent chat-area dhoondo
//       chatArea.hide(); // chat-area ko hide karo

//       // New div create karo
//       var newChatDiv = $("<div class='new-chat-container text-center d-flex align-items-center justify-content-center'>" +
//                          "<a href='new-chat.html' class='btn btn-primary'>New Chat</a>" +
//                          "</div>");

//       // chat-area ke parent me naya div insert karo
//       chatArea.parent().append(newChatDiv);
//   });
// });

// jQuery(document).ready(function(){
//   jQuery(".btn-today").click(function(){
//       jQuery(".today-content").show();
//       jQuery(".yesterday-content").hide();
//   });

//   jQuery(".btn-yesterday").click(function(){
//       jQuery(".today-content").hide();
//       jQuery(".yesterday-content").show();
//   });
// });
